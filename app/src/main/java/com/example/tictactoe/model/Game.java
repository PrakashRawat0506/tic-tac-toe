...
/*
 * Class containing the core logic for the in game operations
 */
public class Game {
    ...
    @Inject
    public Game(@Named("name one") String name1, @Named("name two") String name2) {
    ...
    public Subject<Player> getWinner() {
        return winner;
    }

    public void setWinner(Subject<Player> winner) {
        this.winner = winner;
    }
